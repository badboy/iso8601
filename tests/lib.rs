...
fn test_time() {
    ...
    assert_eq!(Done(&[][..], Time{ hour: 16, minute: 43, second:  0,  millisecond: 0, tz_offset_hours: 0, tz_offset_minutes: 0}), parse_time(b"16:43"));
...
#[test]fn short_time1(){ assert_eq!(parse_time(b"1648"),              Done(&[][..], Time{ hour: 16, minute:48, second:0, millisecond: 0, tz_offset_hours: 0, tz_offset_minutes: 0})); }
#[test]fn short_time2(){ assert_eq!(parse_time(b"16:48"),             Done(&[][..], Time{ hour: 16, minute:48, second:0, millisecond: 0, tz_offset_hours: 0, tz_offset_minutes: 0})); }
#[test]fn short_time3(){ assert_eq!(parse_time(b"16:48Z"),            Done(&[][..], Time{ hour: 16, minute:48, second:0, millisecond: 0, tz_offset_hours: 0, tz_offset_minutes: 0})); }
#[test]fn short_time4(){ assert_eq!(parse_time(b"164800"),            Done(&[][..], Time{ hour: 16, minute:48, second:0, millisecond: 0, tz_offset_hours: 0, tz_offset_minutes: 0})); }
#[test]fn short_time5(){ assert_eq!(parse_time(b"164800.1"),          Done(&[][..], Time{ hour: 16, minute:48, second:0, millisecond: 1, tz_offset_hours: 0, tz_offset_minutes: 0})); }
#[test]fn short_time6(){ assert_eq!(parse_time(b"164800.1Z"),         Done(&[][..], Time{ hour: 16, minute:48, second:0, millisecond: 1, tz_offset_hours: 0, tz_offset_minutes: 0})); }
#[test]fn short_time7(){ assert_eq!(parse_time(b"16:48:00"),          Done(&[][..], Time{ hour: 16, minute:48, second:0, millisecond: 0, tz_offset_hours: 0, tz_offset_minutes: 0})); }

#[test]fn short_twtz1(){ assert_eq!(parse_time(b"1648Z"),   Done(&[][..], Time{ hour: 16, minute:48, second:0, millisecond: 0, tz_offset_hours: 0, tz_offset_minutes: 0})); }
#[test]fn short_twtz2(){ assert_eq!(parse_time(b"16:48Z"),  Done(&[][..], Time{ hour: 16, minute:48, second:0, millisecond: 0, tz_offset_hours: 0, tz_offset_minutes: 0})); }

#[test]fn short_dtim1(){ assert_eq!(parse_datetime(b"20070831T1648"),     Done(&[][..], DateTime{date:Date::YMD{year:2007, month: 08, day: 31}, time:Time{ hour: 16, minute:48, second:0, millisecond: 0, tz_offset_hours: 0, tz_offset_minutes: 0}})); }
#[test]fn short_dtim2(){ assert_eq!(parse_datetime(b"20070831T1648Z"),    Done(&[][..], DateTime{date:Date::YMD{year:2007, month: 08, day: 31}, time:Time{ hour: 16, minute:48, second:0, millisecond: 0, tz_offset_hours: 0, tz_offset_minutes: 0}})); }
#[test]fn short_dtim3(){ assert_eq!(parse_datetime(b"2008-12-24T18:21Z"), Done(&[][..], DateTime{date:Date::YMD{year:2008, month: 12, day: 24}, time:Time{ hour: 18, minute:21, second:0, millisecond: 0, tz_offset_hours: 0, tz_offset_minutes: 0}})); }
